              ...
              >
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: 12, color: theme.onSurfaceVariant }}>
                    {tx.isJoint ? 'Bagi rata 50:50' : 'Patungan Custom'} ΓÇó Rp {formatMoney(tx.partnerContrib)}
                  </Text>
                </View>
              ...
              >
                <Animated.View style={[styles.txItem, { backgroundColor: isHighlighted ? bgColor : theme.surfaceContainer }]}>
                  ...
                  <Text style={[tx.type === 'income' ? styles.txAmountPos : tx.type === 'transfer' ? { color: '#6366F1', fontSize: 14, fontWeight: 'bold' } : styles.txAmountNeg]}>
                    {tx.type === 'income' ? '+' : tx.type === 'transfer' ? 'Γçà' : '-'} {formatMoney(tx.myContrib + tx.partnerContrib)}
                  </Text>
                </Animated.View>
              </TouchableOpacity>
            );
